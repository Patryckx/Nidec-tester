...
class XDM1041:
    ...
    def __init__(self,port:str,bauds:int,timeout=1):
        self.port=port
        self.bauds=bauds
    ...
    def connect(self):
        ...
        try:
            self.connection=serial.Serial(self.port, self.bauds, self.timeout) 
            return True
...
if __name__ =="__main__":
    ...
    multimeter=XDM1041(port,bauds)
    multimeter.connect()
    dc_voltaje=b'MEASURE:VDC?\n'
    try:

        multimeter.send_command(dc_voltaje)
